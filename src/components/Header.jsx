          ...
          >
            <div className="relative mt-3 md:hidden ">
              ...
              <input
                type="text"
                id="search-navbar"
                className="block w-full p-2 pl-10 text-sm text-slate-900 border border-gray-300 rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-black dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search..."
                autoComplete="off"
              ></input>
            </div>
            <ul className=" text-2xl flex flex-col p-4 md:p-0 mt-4 font-medium md:flex-row md:space-x-8 md:mt-0 bg-white dark:bg-gray-900">
              <li>
                <NavLink
                  to="/"
                  className={({ isActive }) =>
